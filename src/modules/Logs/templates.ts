...
export type Templates = {
	[Category in keyof GuildLogTypes]: {
		[LogType in GuildLogTypes[Category]]: MessageEmbedOptions;
	};
};
	...
	members: {
		...
		timeout: {
			...
			author: {
				...
				iconURL:
					'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/muted-speaker_1f507.png',
			},
			thumbnail: {
				url: '{{memberAvatar}}',
			},
		...
		timeoutRemove: {
			...
			author: {
				...
				iconURL:
					'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/speaker-low-volume_1f508.png',
			},
			thumbnail: {
				url: '{{memberAvatar}}',
			},
